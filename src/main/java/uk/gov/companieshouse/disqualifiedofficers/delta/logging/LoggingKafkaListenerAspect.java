package uk.gov.companieshouse.disqualifiedofficers.delta.logging;
...
class LoggingKafkaListenerAspect {
    ...
    LoggingKafkaListenerAspect(@Value("${disqualified-officers.delta.retry-attempts}") int maxAttempts) {
