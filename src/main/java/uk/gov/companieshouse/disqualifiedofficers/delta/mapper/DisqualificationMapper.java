...
public interface DisqualificationMapper {
    ...
    */
    ...
    default void parseReason(
        ...
        disqualifyingLaw.put("CTREGS", "sanctions-counter-terrorism-regulations-2019");
        ...
        if (sectionParts[0].equals("CDDA") || sectionParts[0].equals("SAMLA") || sectionParts[0].equals("CTREGS")) {
